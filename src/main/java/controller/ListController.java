...
public class ListController {
    ...
    public ResponseEntity<ListDTO> getList(@RequestParam Long lid) throws Exception{
        return new ResponseEntity<ListDTO>(listService.getList(lid), HttpStatus.OK);
    }

    @ApiOperation( value = "리스트 수정", notes = "리스트를 수정합니다.")
    @RequestMapping(value = "/updateList", method = RequestMethod.PATCH)
